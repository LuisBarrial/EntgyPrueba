...
```
## Pasos
- Ejecuta el siguiente comando en la terminal dentro del proyecto( Al mismo nivel del /src): mvn clean install
- Aparecerá una carpeta llamada /target
- Dentro de /target habrán 2 JAR (SNAPSHOP[DEFAULT] Y SNAPSHOP-jar-with-dependencies[El que se utilizará])
...
> java -jar target/EntgyPrueba-1.0-SNAPSHOT-jar-with-dependencies.jar "gato|terrestre|miau" "pescao|Acuatico|psss" "nombre|tipo|onomatopeya" "..."
